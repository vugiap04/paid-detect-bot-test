  ...
  return (
    <div className="flex flex-col justify-center gap-2 md:w-3/6 2xl:w-1/3">
      <div className="flex flex-col">
        <b>{texts.accountCenter}</b>
        <b className="text-2xl">{texts.checkNotifications}</b>
      </div>
      ...
      <div>
        <b>{texts.approveFromDevice}</b>
        <p>{texts.codeInstructions}</p>
      </div>
      ...
      <div className="my-2 flex flex-col items-center justify-center">
        ...
        <p className="text-blue-500 hover:underline">{texts.sendCode}</p>
      </div>
    </div>
  );
};
